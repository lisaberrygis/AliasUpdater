...
layerID = "InsertLayerIDHere"
lookupTable = r"C:\path\insertPathtoExcelSpreadsheet.xlsx"
...
# Connect to arcgis portal account that is active in ArcPro
print("\n\nActive Portal in ArcGIS Pro")  
gis = GIS("pro")

# Get layer count from service
updateItem = gis.content.get(itemid=layerID)
...
if lookupTable[-4:] != "xlsx":
    ...
    while restLayerCount > 0:
        ...
        item = gis.content.get(itemid=layerID)
